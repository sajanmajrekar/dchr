...
<div id="sidebar">
    ...
    <div id="sidebar-brand" class="themed-background">
        <a href="index.php" class="sidebar-title">
            <!--<i class="fa fa-cube"></i> <span class="sidebar-nav-mini-hide">DigiChefs</strong></span>-->
            <img  class="logo" src="img/Breeze-Logo-02.png" />
        </a>
    </div>
    <!-- END Sidebar Brand -->
        ...
        <div class="sidebar-content">
            ...
            <ul class="sidebar-nav">
                <?php foreach( $primary_nav as $key => $link ) {
                    ...
                    if ($menu_link || $active) {
                        $link_class = ' class="'. $menu_link . $active . $type.'"';
                    }
                ?>
                ...
                <?php } else if($type){ // If it is a link ?>

...
var App = function() {
    ...
    var uiInit = function() {
        ...
        $('.select-chosen').chosen({width: "100%"});
		 $('#example-chosen-multiple').chosen({max_selected_options: 2,width: "100%"});
		  $('#editexample-chosen-multiple').chosen({max_selected_options: 2,width: "100%"});
		$('#email-chosen-multiple').chosen({width: "100%"});
		$('#roles-multiple').chosen({width: "100%"});

...
$(document).ready(function() {
           sourcedatatable= $('#sourcedatatable').DataTable({
                'ajax': 'php_actions/fetchSource.php',
                'order': [],
                pageLength: 10,
...
function editSource(SourceId = null) {
    ...
    if(SourceId) {
        $.ajax({
            url: 'php_actions/fetchSelectedSource.php',
            type: 'post',
...
function removeSource(sourceid = null) {
	...
	if(sourceid) {
		$.ajax({
				url: 'php_actions/removeSource.php',
				type: 'post',
				data: {sourceid: sourceid},
				dataType: 'json',
				success:function(response) {
...
$('#addSourceform').validate({
                ...
                messages: {
                 ...
                 submitHandler: function(form) {
                                    ...
                                    $.ajax({
                                        url : 'php_actions/createSource.php',
            ...
            $('#EditSourceForm').validate({
                ...
                messages: {
                 ...
                 submitHandler: function(form) {
                                    ...
                                    var formData = $(form).serialize();
                                    $.ajax({
                                        url : 'php_actions/UpdateSelectedSource.php',
                                        type: formactions.attr('method'),
                                        data: formData,
                                        cache: false,
                                        processData: false,

    ...
    <div class="block full">
        <div class="block-title">
            ...
            <div class="btn-group pull-right">
                <button class="btn btn-success" data-target="#addSourceModal"  data-toggle="modal"><i class="fa fa-plus"></i>  Add Role</button>
            </div>
        </div>
                        ...
                        <div class="modal-content">
                          <form action="" id="addSourceform" method="post" class="form-control-borderless">
                            <div class="modal-header">
                                ...
                                <h3 class="modal-title"><strong>Add Role</strong></h3>
                            </div>
                            <div class="modal-body">
                                        <div class="form-group">
                                            <div>
                                                <label for="addsource-name">Role Name <span class="text-danger">*</span></label>
                            ...
                            <div class="modal-footer">
                                <button type="submit"  class="btn btn-effect-ripple btn-primary">Add Role</button>
                    ...
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                          <form action="" id="EditSourceForm" method="post" class="form-control-borderless">
                            ...
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                <h3 class="modal-title"><strong>Edit Role</strong></h3>
                            </div>
                            <div class="modal-body">
                                        <div class="form-group">
                                            <div>
                                                <label for="EditSource-name">Role Name <span class="text-danger">*</span></label>
